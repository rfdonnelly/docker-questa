...
# 1624
rm -rf /opt/mentor/questa/10.5c/questasim/drill_src
# 12260
rm -rf /opt/mentor/questa/10.5c/questasim/vhdl_src
# 22280
rm -rf /opt/mentor/questa/10.5c/questasim/verilog_src
# 28764
rm -rf /opt/mentor/questa/10.5c/questasim/avm
# 78496
rm -rf /opt/mentor/questa/10.5c/questasim/ovm-2.1.1
# 78728
rm -rf /opt/mentor/questa/10.5c/questasim/ovm-2.1.2
# 82016
rm -rf /opt/mentor/questa/10.5c/questasim/examples
# 148252
rm -rf /opt/mentor/questa/10.5c/questasim/uvm-1.1d
# 149548
rm -rf /opt/mentor/questa/10.5c/questasim/uvm-1.1c
# 181100
rm -rf /opt/mentor/questa/10.5c/questasim/RUVM_4.6
# 192204
rm -rf /opt/mentor/questa/10.5c/questasim/vm_src
# total: 975272
